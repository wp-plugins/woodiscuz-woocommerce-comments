<div>
    <h2 style="padding:5px 10px 10px 10px; margin:0px;"><?php _e('General Settings', WPC_Core::$TEXT_DOMAIN); ?></h2>
    <table class="wp-list-table widefat plugins"  style="margin-top:10px; border:none;">
        <tbody>
            <tr valign="top">
                <th scope="row" style="width:55%;">
                    <?php _e('Turn Off WooDiscuz Tab', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td colspan="2">                                
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;">
                    <?php _e('Set the Discussion Tab as the first opened Tab', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td colspan="2">
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;">
                    <?php _e('User Must be registered to comment', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td colspan="2">
                    <fieldset>
                        <label title="Yes">
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;">
                    <?php _e('Is name field required?', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td colspan="2">                                
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;">
                    <?php _e('Is email field required? ', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td colspan="2">                                
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;">
                    <?php _e("Keep comment threads private for product author and thread starter. <br/> This option will not allow users reply in other users' threads, however those will be readable for all.", WPC_Core::$TEXT_DOMAIN); ?> 
                </th>
                <td colspan="2">                                
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;">
                    <?php _e('Usergroups for User Title "Support"', WPC_Core::$TEXT_DOMAIN); ?> 
                </th>
                <td colspan="2">
                    <?php
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;">
                    <?php _e('Comment Threads Per Page', WPC_Core::$TEXT_DOMAIN); ?> 
                </th>
                <td colspan="2">
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;">
                    <label for="wpc_comments_max_depth"><?php _e('Comments max depth', WPC_Core::$TEXT_DOMAIN); ?></label>
                </th>
                <td colspan="2">
                    <select id="wpc_comments_max_depth" name="wpc_comments_max_depth">
                        ...
                        <option value="1" <?php selected($wpc_comments_max_depth, '1'); ?>>1 <?php _e('Level', WPC_Core::$TEXT_DOMAIN); ?></option>
                        <option value="2" <?php selected($wpc_comments_max_depth, '2'); ?>>2 <?php _e('Levels', WPC_Core::$TEXT_DOMAIN); ?></option>
                        <option value="3" <?php selected($wpc_comments_max_depth, '3'); ?>>3 <?php _e('Levels', WPC_Core::$TEXT_DOMAIN); ?></option>
                        <option value="4" <?php selected($wpc_comments_max_depth, '4'); ?>>4 <?php _e('Levels', WPC_Core::$TEXT_DOMAIN); ?></option>
                        <option value="5" <?php selected($wpc_comments_max_depth, '5'); ?>>5 <?php _e('Levels', WPC_Core::$TEXT_DOMAIN); ?></option>            
                    </select>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
                    <label for="wpc_comment_editable_time"><?php _e('Allow comment editing for', WPC_Core::$TEXT_DOMAIN); ?></label>
                </th>
                <td>
                    <select id="wpc_comment_editable_time" name="wpc_comment_editable_time">
                        ...
                        <option value="0" <?php selected($wpc_comment_editable_time, '0'); ?>><?php _e('Not Allow', WPC_Core::$TEXT_DOMAIN); ?></option>
                        <option value="900" <?php selected($wpc_comment_editable_time, '900'); ?>>15 <?php _e('Minutes', WPC_Core::$TEXT_DOMAIN); ?></option>
                        <option value="1800" <?php selected($wpc_comment_editable_time, '1800'); ?>>30 <?php _e('Minutes', WPC_Core::$TEXT_DOMAIN); ?></option>
                        <option value="3600" <?php selected($wpc_comment_editable_time, '3600'); ?>>1 <?php _e('Hour', WPC_Core::$TEXT_DOMAIN); ?></option>
                        <option value="10800" <?php selected($wpc_comment_editable_time, '10800'); ?>>3 <?php _e('Hours', WPC_Core::$TEXT_DOMAIN); ?></option>
                        <option value="86400" <?php selected($wpc_comment_editable_time, '86400'); ?>>24 <?php _e('Hours', WPC_Core::$TEXT_DOMAIN); ?></option>
                    </select>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
                    <?php _e('Redirect first commenter to', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td>
                    <?php
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Allow guests to vote on comments', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td>                                
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;">
                    <?php _e('Use WordPress Date/Time format', WPC_Core::$TEXT_DOMAIN); ?> 
        <p style="font-size:13px; color:#999999; width:80%; padding-left:0px; margin-left:0px;"><?php _e('WooDiscuz shows Human Readable date format. If you check this option it\'ll show the date/time format set in WordPress General Settings.', WPC_Core::$TEXT_DOMAIN); ?></p>
        </th>
        <td colspan="2">
        ...
        <tr valign="top">
            <th scope="row" style="width:55%;">
                <?php _e('Show the latest comments on', WPC_Core::$TEXT_DOMAIN); ?>
            </th>
            <td colspan="2">
                <fieldset class="wpc_comment_list_order">
                    <label title="<?php _e('the top of the list', WPC_Core::$TEXT_DOMAIN) ?>">
                        ...
                        <span><?php _e('top of the threads', WPC_Core::$TEXT_DOMAIN) ?></span>
                    </label> &nbsp;<br/>
                    <label title="<?php _e('bottom of the threads', WPC_Core::$TEXT_DOMAIN) ?>">
                        ...
                        <span><?php _e('the bottom of the list', WPC_Core::$TEXT_DOMAIN) ?></span>
                    </label><br>                                    
                </fieldset>
            </td>
        </tr> 
