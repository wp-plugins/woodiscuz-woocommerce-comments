<div>
    <h2 style="padding:5px 10px 10px 10px; margin:0px;"><?php _e('Form Template Phrases', WPC_Core::$TEXT_DOMAIN); ?></h2>
    <table class="wp-list-table widefat plugins"  style="margin-top:10px; border:none;">
        <tbody>
            <tr valign="top">
                <th scope="row">
                    <?php _e('Comment Field Start', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Comment Field Join', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Email Field', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Name Field', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('CAPTCHA Field', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Submit Button', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Notify on new replies (checkbox)', WPC_Core::$TEXT_DOMAIN); ?>
                </th>
                <td colspan="3">
